...
save
set has_violations {P:\OMNI\Libero\Mario-CM_Flex-EMG_golden\designer\Mario_Libero\Mario_Libero_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {P:\OMNI\Libero\Mario-CM_Flex-EMG_golden\designer\Mario_Libero\Mario_Libero_combinational_loops.xml}
if { [catch "file delete -force -- {P:\OMNI\Libero\Mario-CM_Flex-EMG_golden\designer\Mario_Libero\pinslacks.txt}"] } {
   ;
}
report -type slack {P:\OMNI\Libero\Mario-CM_Flex-EMG_golden\designer\Mario_Libero\pinslacks.txt}
