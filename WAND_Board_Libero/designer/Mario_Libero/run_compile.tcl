...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"P:\OMNI\Libero\Mario-CM_Flex-EMG_golden\synthesis\Mario_Libero.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"P:\OMNI\Libero\Mario-CM_Flex-EMG_golden\constraint\io\Mario_Libero.io.pdc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"P:\OMNI\Libero\Mario-CM_Flex-EMG_golden\constraint\fp\Mario_Libero.fp.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4M6000 \
    -pkg fcs325 \
    -pdc_file {P:\OMNI\Libero\Mario-CM_Flex-EMG_golden\constraint\io\Mario_Libero.io.pdc} \
    -pdc_file {P:\OMNI\Libero\Mario-CM_Flex-EMG_golden\constraint\fp\Mario_Libero.fp.pdc} \
    -merge_pdc 0
