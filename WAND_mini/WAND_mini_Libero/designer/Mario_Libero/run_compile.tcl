...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\flb\Desktop\NeuroMini_golden\synthesis\Mario_Libero.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\flb\Desktop\NeuroMini_golden\constraint\io\Mario_Libero.io.pdc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"C:\Users\flb\Desktop\NeuroMini_golden\constraint\fp\Mario_Libero.fp.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4M2500_N \
    -pkg fcs325 \
    -pdc_file {C:\Users\flb\Desktop\NeuroMini_golden\constraint\io\Mario_Libero.io.pdc} \
    -pdc_file {C:\Users\flb\Desktop\NeuroMini_golden\constraint\fp\Mario_Libero.fp.pdc} \
    -merge_pdc 0
