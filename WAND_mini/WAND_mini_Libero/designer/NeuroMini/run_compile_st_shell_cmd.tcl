...
save
set has_violations {P:\Libero\NeuroMini_golden\designer\NeuroMini\NeuroMini_pre_layout_has_violations}
set fp [open $has_violations w]
puts $fp [has_violations -short]
close $fp
report -type combinational_loops -format xml {P:\Libero\NeuroMini_golden\designer\NeuroMini\NeuroMini_combinational_loops.xml}
if { [catch "file delete -force -- {P:\Libero\NeuroMini_golden\designer\NeuroMini\pinslacks.txt}"] } {
   ;
}
report -type slack {P:\Libero\NeuroMini_golden\designer\NeuroMini\pinslacks.txt}
