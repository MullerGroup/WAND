...
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"P:\Libero\NeuroMini_golden\synthesis\NeuroMini.edn"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"P:\Libero\NeuroMini_golden\constraint\io\NeuroMini.io.pdc"}
set_compile_info \
    -category {"Source Files"} \
    -name {"Source"} \
    -value {"P:\Libero\NeuroMini_golden\constraint\fp\NeuroMini.fp.pdc"}
set_compile_info \
    -category {"Options"} \
...
compile \
    ...
    -die PA4M2500_N \
    -pkg fcs325 \
    -pdc_file {P:\Libero\NeuroMini_golden\constraint\io\NeuroMini.io.pdc} \
    -pdc_file {P:\Libero\NeuroMini_golden\constraint\fp\NeuroMini.fp.pdc} \
    -merge_pdc 0
