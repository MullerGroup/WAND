...
#include "mss_timer.h"
#include <stdbool.h>
#include <../NeuroMini_MSS_CM3_hw_platform/CMSIS/mss_assert.h>
#include <stdlib.h>
#include "arm_math.h"
...
#define NUM_ENABLED_CHANNELS 64
#define CL_NUM_ENABLED_CHANNELS 2
#define DATA_BUF_SIZE 100
#define CL_DATA_BUF_SIZE 6
...
static uint8_t sel_data_vector[64];
...
uint8_t stim_delay = 0;

uint16_t fbin_max2 = 0;
uint16_t fbin_min2 = 0;
bool ctrl_en2 = 0;
bool ctrl_dir2 = 0;
int32_t ctrl_thresh2 = 0;
bool ctrl_comb = 0;
q15_t mean = 0;
